...
def GCN_test(loader):
    ...
    return epoch_sen, epoch_spe, epoch_acc, loss_all / len(val_index)
...
for n_fold, (train_index, valtest_index) in enumerate(skf.split(labels, labels)):
    ...
    val_index, test_index, _, _ = train_test_split(valtest_index, dataset[valtest_index][2], test_size=0.5,
                                                   shuffle=True, stratify=dataset[valtest_index][2])
